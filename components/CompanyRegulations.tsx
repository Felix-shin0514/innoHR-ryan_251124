...
const CompanyRegulations: React.FC<CompanyRegulationsProps> = ({ user }) => {
  ...
  const handleDeleteDoc = (id: string) => {
    if (window.confirm('정말 이 규정을 삭제하시겠습니까?')) {
                    ...
                    <td className="px-6 py-4 text-center">
                      ...
                      {isAdmin && (
                        <button
                          ...
                          className="p-2 ml-2 text-slate-400 hover:text-red-600 dark:hover:text-red-400 bg-slate-100 dark:bg-slate-800 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-lg transition-all"
                          title="규정 삭제"
                        >
